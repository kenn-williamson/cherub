-- M6a/M6b: Initial schema — sessions + messages + memory tables
-- Targeting PostgreSQL 18 with pgvector extension.
-- All DB-generated IDs use uuidv7() (PG 18 built-in, time-sortable, better B-tree indexing).
...
CREATE TABLE IF NOT EXISTS memories (
    ...
    -- Scope: 'agent' (shared, Commit to modify), 'user' (per-user, Act to modify),
    --        'working' (continuity context, Observe to modify)
